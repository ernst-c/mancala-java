...
public class App {
    ...
    private static ResourceConfig createResources() {
        ...
        IMancalaFactory factory = new MancalaFactory(); // TODO: get implementation from domain
        IMancalaRepository db_repository = new DBMancalaRepository();
        IMancalaRepository local_repository = new MancalaRepository();
        MancalaController mancalaController = new MancalaController(factory, local_repository, db_repository);
